...
class PricingAdvOption extends OptionAbstract {
	...
	public function get_option_label(): string {
		...
		/* translators: %1$s: break line, %2$s: anchor opening tag, %3$s: anchor closing tag */
			__( 'Add a fixed or percentage price to the field and set the tax on this price.%1$s <b>BLACK FRIDAY IS HERE!</b><br>USE CODE FCF30WOW AT CHECKOUT<br> %2$sUpgrade to PRO%3$s', 'flexible-checkout-fields' ),
			'<br>',
