	...
	private function load_translations(): array {
		return [
			...
			/* translators: %1$s: break line, %2$s: anchor opening tag, %3$s: anchor closing tag */
				__( 'This field is available in the PRO version.<br><b>BLACK FRIDAY IS HERE!</b><br>USE CODE FCF30WOW AT CHECKOUT <br> %1$s %2$sUpgrade to PRO%3$s', 'flexible-checkout-fields' ),
				'<br>',
